...
Blockly.Blocks.servo_attach = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blocks/servo/servomoteur.jpg', 64, 64));
    this.appendDummyInput("")
...
Blockly.Blocks.servo_rot_continue = {
  init: function() {
	...
	this.appendDummyInput()
		...
		.appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blocks/servo/servomoteur_rot_continue.jpg', 64, 64));
    this.appendDummyInput("")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(
            new Blockly.FieldInstance('Servo',
